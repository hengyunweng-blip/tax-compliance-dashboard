...
export function AnnualPageClient({ entities, initialWorksheets, initialIncomeYear }: Props) {
  ...
  return (
    <main className="ledger-shell" data-testid="annual-page">
      ...
      <section className="ledger-content"><header className="ledger-header"><div><p className="page-kicker">Gate 5 · 所属年度聚合</p><h1>年度底稿</h1><p>公司、信托和个人均按 income_year 汇总；所有自动计算都保留来源交易，人工项目不会被假装已完成。</p></div></header>
