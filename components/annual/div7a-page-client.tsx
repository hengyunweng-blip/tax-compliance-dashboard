...
export function Div7aPageClient({ entities, initialLoans }: { entities: Array<{ id: string; name: string }>; initialLoans: Div7aSummary[] }) {
  ...
  async function refresh() {
    const response = await fetch("/api/div7a?fy=2026-27");
