...
export function Div7aPageClient({ entities, initialLoans, initialIncomeYear }: { entities: Array<{ id: string; name: string }>; initialLoans: Div7aLoanView[]; initialIncomeYear: string }) {
  const [loans, setLoans] = useState(initialLoans);
  const [assessmentIncomeYear, setAssessmentIncomeYear] = useState(initialIncomeYear);
  const assessmentIncomeYearRef = useRef(initialIncomeYear);
