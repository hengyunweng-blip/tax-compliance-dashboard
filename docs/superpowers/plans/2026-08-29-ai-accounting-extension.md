...
- [x] **Step 6: Implemented in the Gate 6 working-tree change; final integration commit is deferred until the complete Gate 6 evidence is recorded.**
...
- [x] **Step 6: Run agreement/reminder tests, SQL inspection and lint**; included in the Gate 6 working-tree change pending final evidence commit.
